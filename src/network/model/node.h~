...
{
public:
  bool isPU(){return PUNode;}
  void setPU(bool isPU){PUNode = isPU;}
  Ipv4Address addr;
...
/**
returns the Rx in the current momoent
**/
 double calcRx();

 void setNodeList (std::vector<Ptr<Node> > theList){nodeList = theList;}
 std::vector<Ptr<Node> > getNodeList(){return nodeList;}
