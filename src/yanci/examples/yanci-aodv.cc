...
int main(int argc, char *argv[])
{
	...
	Ptr<OutputStreamWrapper> routingStream2 = Create<OutputStreamWrapper> ("aodv.routes", std::ios::out);
	aodv.PrintRoutingTableAllAt (Seconds(35.0), routingStream2);
	...
	*/
	...
	std::string ascfile("yanci-aodv-24");
