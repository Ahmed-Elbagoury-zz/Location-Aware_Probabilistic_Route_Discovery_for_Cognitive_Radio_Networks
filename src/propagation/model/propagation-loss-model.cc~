...
double
PropagationLossModel::customCalcRxPower (Ptr<MobilityModel> a,
                                             Ptr<MobilityModel> b) const
{
//        cout << "In PropagationLossModel::customCalcRxPower" <<endl;
        return DocustomCalcRxPower(a, b);
}


double
PropagationLossModel::DocustomCalcRxPower (Ptr<MobilityModel> a,
                                             Ptr<MobilityModel> b) const
{
cout << "In PropagationLossModel custom method" <<endl;
return 4.0;
}
...
PropagationLossModel::CalcRxPower (double txPowerDbm,
                                   ...
                                   Ptr<MobilityModel> b) const
{
//  cout << "Starting to calcRxPower ... " << endl;
  double self = DoCalcRxPower (txPowerDbm, a, b);
  //DocustomCalcRxPower(a, b);
  if (m_next != 0)
    {
...
RandomPropagationLossModel::DoCalcRxPower (double txPowerDbm,
                                           ...
                                           Ptr<MobilityModel> b) const
{
//cout << "In RandomPropagationLossModel" << endl;
...
double
RandomPropagationLossModel::DocustomCalcRxPower (Ptr<MobilityModel> a,
                                             Ptr<MobilityModel> b) const
{
cout << "In RandomPropagationLossModel custom method" <<endl;
return 4.0;
}
...
FriisPropagationLossModel::DoCalcRxPower (double txPowerDbm,
                                          ...
                                          Ptr<MobilityModel> b) const
{
//cout << "In FriisPropagationLossModel" << endl;
  /*
...
double
FriisPropagationLossModel::DocustomCalcRxPower (Ptr<MobilityModel> a,
                                             Ptr<MobilityModel> b) const
{
cout << "In FriisPropagationLossModel custom method" <<endl;
return 4.0;
}
...
TwoRayGroundPropagationLossModel::DoCalcRxPower (double txPowerDbm,
                                                 ...
                                                 Ptr<MobilityModel> b) const
{
//cout << "In TwoRayGroundPropagationLossModel" << endl;
  /*
...
double
TwoRayGroundPropagationLossModel::DocustomCalcRxPower (Ptr<MobilityModel> a,
                                             Ptr<MobilityModel> b) const
{
cout << "In TwoRayGroundPropagationLossModel custom method" <<endl;
return 4.0;
}
...
double
LogDistancePropagationLossModel::DocustomCalcRxPower (Ptr<MobilityModel> a,
                                             Ptr<MobilityModel> b) const
{
cout << "In LogDistancePropagationLossModel custom method" <<endl;
return 4.0;
}
...
LogDistancePropagationLossModel::DoCalcRxPower (double txPowerDbm,
                                                ...
                                                Ptr<MobilityModel> b) const
{
//cout << "In LogDistancePropagationLossModel" << endl;
  double distance = a->GetDistanceFrom (b);
...
ThreeLogDistancePropagationLossModel::DoCalcRxPower (double txPowerDbm,
                                                     ...
                                                     Ptr<MobilityModel> b) const
{
//cout << "In ThreeLogDistancePropagationLossModel" <<endl;
  double distance = a->GetDistanceFrom (b);
...
double
ThreeLogDistancePropagationLossModel::DocustomCalcRxPower (Ptr<MobilityModel> a,
                                             Ptr<MobilityModel> b) const
{
cout << "In ThreeLogDistancePropagationLossModel custom method" <<endl;
return 4.0;
}
...
NakagamiPropagationLossModel::DoCalcRxPower (double txPowerDbm,
                                             ...
                                             Ptr<MobilityModel> b) const
{
//cout << "In NakagamiPropagationLossModel" << txPowerDbm <<endl;
  // select m parameter
...
double
NakagamiPropagationLossModel::DocustomCalcRxPower (Ptr<MobilityModel> a,
                                             Ptr<MobilityModel> b) const
{
//cout << "In NakagamiPropagationLossModel custom method" <<endl;
  // select m parameter
  ...
  // the current power unit is dBm, but Watt is put into the Nakagami /
  // Rayleigh distribution.
  double powerW = std::pow (10, (TX_POWER_DBM - 30) / 10);
...
FixedRssLossModel::DoCalcRxPower (double txPowerDbm,
                                  ...
                                  Ptr<MobilityModel> b) const
{
//cout << "In FixedRssLossModel" <<endl;
  return m_rss;
}
...
double
FixedRssLossModel::DocustomCalcRxPower (Ptr<MobilityModel> a,
                                             Ptr<MobilityModel> b) const
{
cout << "In FixedRssLossModel custom method" <<endl;
return 4.0;
}
...
MatrixPropagationLossModel::DoCalcRxPower (double txPowerDbm,
                                           ...
                                           Ptr<MobilityModel> b) const
{
//cout << "In MatrixPropagationLossModel" <<endl;
...
double
MatrixPropagationLossModel::DocustomCalcRxPower (Ptr<MobilityModel> a,
                                             Ptr<MobilityModel> b) const
{
cout << "In MatrixPropagationLossModel custom method" <<endl;
return 4.0;
}
...
RangePropagationLossModel::DoCalcRxPower (double txPowerDbm,
                                          ...
                                          Ptr<MobilityModel> b) const
{
//cout << "In RangePropagationLossModel" << endl;
  double distance = a->GetDistanceFrom (b);
  if (distance <= m_range)
    {
      return txPowerDbm;
...
double
RangePropagationLossModel::DocustomCalcRxPower (Ptr<MobilityModel> a,
                                             Ptr<MobilityModel> b) const
{
cout << "In RangePropagationLossModel custom method" <<endl;
return 4.0;
}
